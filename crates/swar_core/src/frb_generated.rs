...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -31034850;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        11 => wire__crate__api__history__initialize_local_store_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        12 => wire__crate__api__history__insights_snapshot_default_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        13 => wire__crate__api__models__install_recommended_model_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        14 => wire__crate__api__dictation__list_microphones_impl(port, ptr, rust_vec_len, data_len),
        15 => wire__crate__api__personalization__list_vocabulary_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        16 => wire__crate__api__history__load_history_page_impl(port, ptr, rust_vec_len, data_len),
        17 => wire__crate__api__history__load_insights_snapshot_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        19 => wire__crate__api__settings__native_settings_default_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        21 => wire__crate__api__dictation__prepare_audio_capture_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        22 => wire__crate__api__dictation__prepare_dictation_engine_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        24 => wire__crate__api__personalization__record_user_edit_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        25 => wire__crate__api__dictation__release_dictation_engine_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        27 => wire__crate__api__dictation__start_dictation_session_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        28 => wire__crate__api__diagnostics__stream_demo_events_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        18 => wire__crate__api__settings__load_settings_impl(ptr, rust_vec_len, data_len),
        20 => wire__crate__api__dictation__offline_model_is_ready_impl(ptr, rust_vec_len, data_len),
        23 => wire__crate__api__models__recommended_model_status_impl(ptr, rust_vec_len, data_len),
        26 => wire__crate__api__settings__save_settings_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
